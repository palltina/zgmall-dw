package com.zhao.zmall.dw.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.zhao.zmall.dw.mock.utils.*;
...
public class JsonMocker {
    ...
    RanOpt[] quitOpts= {   new RanOpt(true,80),new RanOpt(false,20)};
    ...
    String initStartupLog( ){
     ...
     `area` string COMMENT '城市' */
        ...
        String mid= "mid_"+ RandomNum.getRandInt(450,1200);
